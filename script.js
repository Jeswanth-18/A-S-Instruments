function update(e){
    ...
    var outputn = '';
    var numString =   e.value;
    var finlOutPut = new Array();
 
    if (numString == '0') {
        
        e.parentElement.children[3].innerHTML  = 'Zero';
        return;
    }
 
    if (numString == "") {
        
        e.parentElement.children[3].innerHTML = '';
        return;
    }
    ...
    for (b = finlOutPut.length - 1; b >= 0; b--) {
        ...
        for(n = 0; n<finlOutPut.length; n++){
            outputn +=finlOutPut[n];
        }
 
        e.parentElement.children[3].innerHTML = outputn;//print the output
 }
